...
public class Services {
    ...
    public Services(FrameRepository frameRepository, FrameMapper frameMapper, StopRepository stopRepository, StopMapper stopMapper, StudentRepository studentRepository, RequireMapper requireMapper, RequireRepository requireRepository ){
